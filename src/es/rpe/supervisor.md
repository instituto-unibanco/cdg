...
## 3.2. Instrumento de acompanhamento da aula pelo PCA
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<br>( ) Atividades manuais, como recorte e colagem, desenho, produção de cartazes, escultura, maquetes, modelagens de protótipos etc. 
